...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/css_dash/cs-skin-elastic.css')}}">
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="{{asset('img/images/wh6sorDM.png')}}" alt="Logo"
                                                           height="40"></a>
                    <a class="navbar-brand hidden" href="./"><img src="{{asset('img/images/logo2.png')}}"
                                                                  alt="Logo"></a>
                ...
                <div class="header-menu">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                                                        src="{{asset('img/images/avatar/1.jpg')}}"></span>
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                                                        src="{{asset('img/images/avatar/2.jpg')}}"></span>
                                    <div class="message media-body">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                                                        src="{{asset('img/images/avatar/3.jpg')}}"></span>
                                    <div class="message media-body">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                                                        src="{{asset('img/images/avatar/4.jpg')}}"></span>
                                    <div class="message media-body">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true"
                           aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{asset('img/images/admin.jpg')}}"
                                 alt="User Avatar">
                        </a>
                                        ...
                                        <table class="table ">
                                                ...
                                                <td class="avatar">
                                                    <div class="round-img">
                                                        <a href="#"><img class="rounded-circle"
                                                                         src="{{asset('img/images/avatar/1.jpg')}}"
                                                                         alt=""></a>
                                                    </div>
                                                </td>
                                                <td> #5469</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="avatar">
                                                    <div class="round-img">
                                                        <a href="#"><img class="rounded-circle"
                                                                         src="{{asset('img/images/avatar/2.jpg')}}"
                                                                         alt=""></a>
                                                    </div>
                                                </td>
                                                <td> #5468</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="avatar">
                                                    <div class="round-img">
                                                        <a href="#"><img class="rounded-circle"
                                                                         src="{{asset('img/images/avatar/3.jpg')}}"
                                                                         alt=""></a>
                                                    </div>
                                                </td>
                                                <td> #5467</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="avatar">
                                                    <div class="round-img">
                                                        <a href="#"><img class="rounded-circle"
                                                                         src="{{asset('img/images/avatar/4.jpg')}}"
                                                                         alt=""></a>
                                                    </div>
                                                </td>
                                                <td> #5466</td>
                                            ...
                                            <tr class=" pb-0">
                                                ...
                                                <td class="avatar pb-0">
                                                    <div class="round-img">
                                                        <a href="#"><img class="rounded-circle"
                                                                         src="{{asset('img/images/avatar/6.jpg')}}"
                                                                         alt=""></a>
                                                    </div>
                                                </td>
                                                <td> #5465</td>
                                                    ...
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" checked><i
                                                                class="check-box"></i><span>Follow back those who follow you</span>
                                                            <a href='#' class="fa fa-times"></a>
                                                            <a href='#' class="fa fa-pencil"></a>
                                                            <a href='#' class="fa fa-check"></a>
                                                        </label>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="msg-received msg-container">
                                                    <div class="avatar">
                                                        <img src="{{asset('img/images/avatar/64-1.jpg')}}" alt="">
                                            ...
                                            <li>
                                                <div class="msg-sent msg-container">
                                                    <div class="avatar">
                                                        <img src="{{asset('img/images/avatar/64-2.jpg')}}" alt="">
                                                        <div class="send-time">11.11 am</div>
                                                    </div>
                                                    <div class="msg-box">
                                                        <div class="inner-box">
